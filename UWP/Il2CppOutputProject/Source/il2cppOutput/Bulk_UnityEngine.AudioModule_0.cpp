...
extern Il2CppCodeGenString* _stringLiteral2471574756;
extern Il2CppCodeGenString* _stringLiteral1087634904;
extern Il2CppCodeGenString* _stringLiteral1974720957;
...
extern Il2CppCodeGenString* _stringLiteral2997775034;
...
IL_0082:
	...
	}
	{
		...
		G_B13_0 = ((int32_t)((int32_t)1+(int32_t)((int32_t)((int32_t)L_22/(int32_t)8))));
		goto IL_00ab;
	}
...
IL_010f:
	{
		...
		((AudioExtensionManager_t3220897493_StaticFields*)il2cpp_codegen_static_fields_for(AudioExtensionManager_t3220897493_il2cpp_TypeInfo_var))->set_m_NextStopIndex_4(((int32_t)((int32_t)L_37+(int32_t)1)));
...
extern "C"  void AudioSource_PlayClipAtPoint_m3985620478 (RuntimeObject * __this /* static, unused */, AudioClip_t3680889665 * ___clip0, Vector3_t3722313464  ___position1, float ___volume2, const RuntimeMethod* method)
{
	...
	GameObject_t1113636619 * G_B3_2 = NULL;
	{
		...
		IL2CPP_RUNTIME_CLASS_INIT(Type_t_il2cpp_TypeInfo_var);
		Type_t * L_5 = Type_GetTypeFromHandle_m1620074514(NULL /*static, unused*/, LoadTypeToken(AudioSource_t3935305588_0_0_0_var), /*hidden argument*/NULL);
		NullCheck(L_4);
		Component_t1923634451 * L_6 = GameObject_AddComponent_m136524825(L_4, L_5, /*hidden argument*/NULL);
		V_1 = ((AudioSource_t3935305588 *)CastclassSealed((RuntimeObject*)L_6, AudioSource_t3935305588_il2cpp_TypeInfo_var));
		AudioSource_t3935305588 * L_7 = V_1;
		AudioClip_t3680889665 * L_8 = ___clip0;
		NullCheck(L_7);
		AudioSource_set_clip_m31653938(L_7, L_8, /*hidden argument*/NULL);
		AudioSource_t3935305588 * L_9 = V_1;
		NullCheck(L_9);
		AudioSource_set_spatialBlend_m3924907960(L_9, (1.0f), /*hidden argument*/NULL);
		AudioSource_t3935305588 * L_10 = V_1;
		float L_11 = ___volume2;
		NullCheck(L_10);
		AudioSource_set_volume_m1273312851(L_10, L_11, /*hidden argument*/NULL);
		AudioSource_t3935305588 * L_12 = V_1;
		NullCheck(L_12);
		AudioSource_Play_m48294159(L_12, /*hidden argument*/NULL);
		GameObject_t1113636619 * L_13 = V_0;
		AudioClip_t3680889665 * L_14 = ___clip0;
		NullCheck(L_14);
		float L_15 = AudioClip_get_length_m4269890037(L_14, /*hidden argument*/NULL);
		float L_16 = Time_get_timeScale_m701790074(NULL /*static, unused*/, /*hidden argument*/NULL);
		G_B1_0 = L_15;
		G_B1_1 = L_13;
...
IL_0072:
	{
		IL2CPP_RUNTIME_CLASS_INIT(Object_t631007953_il2cpp_TypeInfo_var);
		Object_Destroy_m3118546832(NULL /*static, unused*/, G_B3_2, ((float)((float)G_B3_1*(float)G_B3_0)), /*hidden argument*/NULL);
		return;
	}
}
...
extern "C"  StringU5BU5D_t1281789340* Microphone_get_devices_m3058582080 (RuntimeObject * __this /* static, unused */, const RuntimeMethod* method)
{
...
extern "C"  bool Microphone_IsRecording_m2946688696 (RuntimeObject * __this /* static, unused */, String_t* ___deviceName0, const RuntimeMethod* method)
{
...
extern "C"  void Microphone_GetDeviceCaps_m2711313270 (RuntimeObject * __this /* static, unused */, String_t* ___deviceName0, int32_t* ___minFreq1, int32_t* ___maxFreq2, const RuntimeMethod* method)
{
