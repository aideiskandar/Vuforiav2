...
extern const uint32_t NativeInputSystem_HasDeviceDiscoveredHandler_m1822694604_MetadataUsageId;
...
extern "C"  void NativeDeviceDiscoveredCallback_Invoke_m2547691835 (NativeDeviceDiscoveredCallback_t3494240628 * __this, NativeInputDeviceInfo_t3032009285  ___deviceInfo0, const RuntimeMethod* method)
{
	...
	if (delegatesToInvoke != NULL)
	{
		...
		for (il2cpp_array_size_t i = 0; i < length; i++)
		{
			...
			{
				typedef void (*FunctionPointerType) (RuntimeObject *, void* __this, NativeInputDeviceInfo_t3032009285  ___deviceInfo0, const RuntimeMethod* method);
			...
			{
				typedef void (*FunctionPointerType) (void* __this, NativeInputDeviceInfo_t3032009285  ___deviceInfo0, const RuntimeMethod* method);
...
extern "C"  bool NativeInputSystem_HasDeviceDiscoveredHandler_m1822694604 (RuntimeObject * __this /* static, unused */, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (NativeInputSystem_HasDeviceDiscoveredHandler_m1822694604_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	bool V_0 = false;
	{
		NativeDeviceDiscoveredCallback_t3494240628 * L_0 = ((NativeInputSystem_t922881982_StaticFields*)il2cpp_codegen_static_fields_for(NativeInputSystem_t922881982_il2cpp_TypeInfo_var))->get_onDeviceDiscovered_2();
		V_0 = (bool)((((int32_t)((((RuntimeObject*)(NativeDeviceDiscoveredCallback_t3494240628 *)L_0) == ((RuntimeObject*)(RuntimeObject *)NULL))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_0012;
	}
